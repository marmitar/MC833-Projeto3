...
def fastica(X, n_components=..., *, algorithm=..., whiten=..., fun=..., fun_args=..., max_iter=..., tol=..., w_init=..., whiten_solver=..., random_state=..., return_X_mean=..., compute_sources=..., return_n_iter=...): # -> list[Any | _Array[tuple[int, int], float64] | ndarray[tuple[int, int], dtype[float64 | floating[_32Bit]]] | None]:
