...
class PHReg(model.LikelihoodModel):
    ...
    def score_residuals(self, params): # -> _Array[tuple[()], float64]:
        """
...
class PHRegResults(base.LikelihoodModelResults):
    ...
    def predict(self, endog=..., exog=..., strata=..., offset=..., transform=..., pred_type=...): # -> Series | DataFrame:
        ...
    ...
    @cache_readonly
    def schoenfeld_residuals(self): # -> NDArray[float64]:
        """
    ...
    @cache_readonly
    def martingale_residuals(self): # -> NDArray[float64]:
        """
