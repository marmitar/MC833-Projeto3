...
class ExponentialSmoothing(TimeSeriesModel):
    ...
    def initial_values(self, initial_level=..., initial_trend=..., force=...): # -> tuple[float | Any | NDArray[Any] | tuple[Any, ndarray[Any, Any] | Any] | tuple[Any, ndarray[Any, Any] | Any, tuple[tuple[Any, RootResults] | Any, tuple[Any, RootResults] | Any]] | None, float | Any | None, Any | ndarray[tuple[int], dtype[Any]] | Incomplete | None] | tuple[Any | NDArray[Any] | tuple[Any, ndarray[Any, Any] | Any] | tuple[Any, ndarray[Any, Any] | Any, tuple[tuple[Any, RootResults] | Any, tuple[Any, RootResults] | Any]], Any | NDArray[float64] | NDArray[Any] | None, list[Any]]:
        """
