...
def select_order(data, maxlags: int, deterministic: str = ..., seasons: int = ..., exog=..., exog_coint=...): # -> LagOrderResults:
    """
...
class VECMResults:
    ...
    @cache_readonly
    def stderr_coint(self): # -> _Array[tuple[int, int], float64] | NDArray[float64]:
        """
    ...
    @cache_readonly
    def stderr_alpha(self): # -> ndarray[tuple[()], dtype[Any]]:
        ...

    @cache_readonly
    def stderr_beta(self): # -> ndarray[tuple[()], dtype[float64]]:
        ...

    @cache_readonly
    def stderr_det_coef_coint(self): # -> NDArray[float32 | complex64] | ndarray[tuple[()], dtype[float64]]:
        ...

    @cache_readonly
    def stderr_gamma(self): # -> ndarray[tuple[()], dtype[Any]]:
        ...

    @cache_readonly
    def stderr_det_coef(self): # -> NDArray[float32 | complex64] | ndarray[tuple[()], dtype[Any]]:
        ...

    @cache_readonly
    def tvalues_alpha(self): # -> NDArray[complex128]:
        ...

    @cache_readonly
    def tvalues_beta(self): # -> NDArray[inexact[Any, float | complex]]:
        ...

    @cache_readonly
    def tvalues_det_coef_coint(self): # -> NDArray[float32 | complex64] | NDArray[inexact[Any, float | complex]]:
        ...

    @cache_readonly
    def tvalues_gamma(self): # -> NDArray[complex128]:
        ...

    @cache_readonly
    def tvalues_det_coef(self): # -> NDArray[float32 | complex64] | NDArray[inexact[Any, float | complex]] | NDArray[complex128]:
        ...

    @cache_readonly
    def pvalues_alpha(self): # -> ndarray[_AnyShape, dtype[Any]] | ndarray[tuple[()], dtype[Any]]:
        ...

    @cache_readonly
    def pvalues_beta(self): # -> NDArray[float64]:
        ...

    @cache_readonly
    def pvalues_det_coef_coint(self): # -> NDArray[float32 | complex64] | ndarray[_AnyShape, dtype[Any]] | ndarray[tuple[()], dtype[Any]]:
        ...

    @cache_readonly
    def pvalues_gamma(self): # -> ndarray[_AnyShape, dtype[Any]] | ndarray[tuple[()], dtype[Any]]:
        ...

    @cache_readonly
    def pvalues_det_coef(self): # -> NDArray[float32 | complex64] | ndarray[_AnyShape, dtype[Any]] | ndarray[tuple[()], dtype[Any]]:
        ...

    def conf_int_alpha(self, alpha=...): # -> _Array1D[Any]:
        ...

    def conf_int_beta(self, alpha=...): # -> _Array1D[Any]:
        ...

    def conf_int_det_coef_coint(self, alpha=...): # -> _Array1D[Any]:
        ...

    def conf_int_gamma(self, alpha=...): # -> _Array1D[Any]:
        ...

    def conf_int_det_coef(self, alpha=...): # -> _Array1D[Any]:
        ...

    @cache_readonly
    def var_rep(self): # -> _Array[tuple[int, int, int], float64]:
        ...
    ...
    def predict(self, steps=..., alpha=..., exog_fc=..., exog_coint_fc=...): # -> tuple[Any | _Array[tuple[int, int], float64], Any | NDArray[float64], Any | NDArray[float64]] | Any | ndarray[tuple[int, int], dtype[float64]]:
        """
