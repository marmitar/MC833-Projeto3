...
"""
def ma_rep(coefs, maxn=...): # -> _Array[tuple[int, int, int], float64]:
    r"""
...
def is_stable(coefs, verbose=...): # -> numpy.bool[builtins.bool]:
    """
...
def var_acf(coefs, sig_u, nlags=...): # -> _Array[tuple[int, int, int], float64]:
    """
...
def forecast_cov(ma_coefs, sigma_u, steps): # -> _Array[tuple[int, int, int], float64]:
    r"""
...
mse = ...
def forecast(y, coefs, trend_coefs, steps, exog=...): # -> Any | _Array[tuple[int, int], float64]:
    """
...
def forecast_interval(y, coefs, trend_coefs, sig_u, steps=..., alpha=..., exog=...): # -> tuple[Any | _Array[tuple[int, int], float64], Any | NDArray[float64], Any | NDArray[float64]]:
    ...
...
class VAR(TimeSeriesModel):
    ...
    def predict(self, params, start=..., end=..., lags=..., trend=...): # -> NDArray[Any] | ndarray[tuple[int, int], dtype[float64]]:
        """
...
class VARProcess:
    ...
    def is_stable(self, verbose=...): # -> numpy.bool[builtins.bool]:
    ...
    def simulate_var(self, steps=..., offset=..., seed=..., initial_values=..., nsimulations=...): # -> ndarray[tuple[int, ...], dtype[float64]]:
        """
    ...
    def ma_rep(self, maxn=...): # -> _Array[tuple[int, int, int], float64]:
        r"""
    ...
    def acf(self, nlags=...): # -> _Array[tuple[int, int, int], float64]:
    ...
    def acorr(self, nlags=...): # -> NDArray[float64]:
        """
    ...
    def forecast(self, y, steps, exog_future=...): # -> Any | _Array[tuple[int, int], float64]:
    ...
    def mse(self, steps): # -> _Array[tuple[int, int, int], float64]:
        r"""
        Compute theoretical forecast error variance matrices
    ...
    forecast_cov = ...
    def forecast_interval(self, y, steps, alpha=..., exog_future=...): # -> tuple[Any | _Array[tuple[int, int], float64], Any | NDArray[float64], Any | NDArray[float64]]:
        """
...
class VARResults(VARProcess):
    ...
    def sample_acov(self, nlags=...): # -> NDArray[float64]:
        """Sample acov"""
        ...

    def sample_acorr(self, nlags=...): # -> NDArray[float64]:
        """Sample acorr"""
        ...
    ...
    def resid_acov(self, nlags=...): # -> NDArray[float64]:
        """
    ...
    def resid_acorr(self, nlags=...): # -> NDArray[float64]:
        """
    ...
    @cache_readonly
    def stderr(self): # -> ndarray[tuple[()], dtype[Any]]:
        """Standard errors of coefficients, reshaped to match in size"""
        ...

    bse = ...
    @cache_readonly
    def stderr_endog_lagged(self): # -> ndarray[_AnyShape, dtype[Any]]:
        """Stderr_endog_lagged"""
        ...

    @cache_readonly
    def stderr_dt(self): # -> ndarray[_AnyShape, dtype[Any]]:
        """Stderr_dt"""
        ...
    ...
    @cache_readonly
    def pvalues_endog_lagged(self): # -> ndarray[_AnyShape, dtype[Any]]:
        """pvalues_endog_laggd"""
        ...

    @cache_readonly
    def pvalues_dt(self): # -> ndarray[_AnyShape, dtype[Any]]:
        """pvalues_dt"""
        ...
    ...
    def forecast_cov(self, steps=..., method=...): # -> _Array[tuple[int, int, int], float64]:
    ...
    def irf_errband_mc(self, orth=..., repl=..., steps=..., signif=..., seed=..., burn=..., cum=...): # -> tuple[ndarray[_AnyShape, dtype[float64]], ndarray[_AnyShape, dtype[float64]]]:
        """
    ...
    def irf_resim(self, orth=..., repl=..., steps=..., seed=..., burn=..., cum=...): # -> _Array[tuple[int, int, int, int], float64]:
        """
    ...
    @cache_readonly
    def roots(self): # -> ndarray[_AnyShape, dtype[Any]]:
        """
