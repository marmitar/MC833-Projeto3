...
class PredictionResults:
    ...
    @property
    def predicted_mean(self): # -> Series | DataFrame:
        """The predicted mean"""
        ...

    @property
    def var_pred_mean(self): # -> NDArray[Any] | Series | DataFrame:
        """The variance of the predicted mean"""
        ...

    @property
    def se_mean(self): # -> Series | DataFrame:
        """The standard deviation of the predicted mean"""
        ...

    @property
    def tvalues(self): # -> Series | _NotImplementedType:
    ...
    def conf_int(self, alpha=...): # -> Series | DataFrame | NDArray[Any]:
        """
