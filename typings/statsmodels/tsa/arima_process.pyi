...
NONSTATIONARY_ERROR = ...
def arma_generate_sample(ar, ma, nsample, scale=..., distrvs=..., axis=..., burnin=...): # -> ndarray[_AnyShape, dtype[Any]]:
    """
...
def arma_acovf(ar, ma, nobs=..., sigma2=..., dtype=...): # -> _Array1D[floating[_16Bit] | Any] | ndarray[_AnyShape, dtype[floating[_16Bit] | Any]]:
    """
...
def arma_pacf(ar, ma, lags=...): # -> _Array1D[float64]:
    """
...
def arma_periodogram(ar, ma, worN=..., whole=...): # -> tuple[NDArray[float64], Any]:
    """
...
def arma_impulse_response(ar, ma, leads=...): # -> ndarray[_AnyShape, dtype[Any]] | tuple[ndarray[_AnyShape, dtype[Any]], ndarray[_AnyShape, dtype[Any]]]:
    """
...
def arma2ma(ar, ma, lags=...): # -> ndarray[_AnyShape, dtype[Any]] | tuple[ndarray[_AnyShape, dtype[Any]], ndarray[_AnyShape, dtype[Any]]]:
    """
...
def arma2ar(ar, ma, lags=...): # -> ndarray[_AnyShape, dtype[Any]] | tuple[ndarray[_AnyShape, dtype[Any]], ndarray[_AnyShape, dtype[Any]]]:
    """
...
def ar2arma(ar_des, p, q, n=..., mse=..., start=...): # -> tuple[tuple[Incomplete], Incomplete, Any | tuple[Any, Any]]:
    """
...
_arma_docs = ...
def lpol2index(ar): # -> tuple[Any | ndarray[_AnyShape, dtype[Any]], NDArray[intp]]:
    """
...
def index2lpol(coeffs, index): # -> _Array1D[float64]:
    """
...
def deconvolve(num, den, n=...): # -> tuple[ndarray[_AnyShape, dtype[Any]] | tuple[ndarray[_AnyShape, dtype[Any]], ndarray[_AnyShape, dtype[Any]]] | Any | list[Any], NDArray[Any] | NDArray[float64] | Any]:
...
class ArmaProcess:
    ...
    def acovf(self, nobs=...): # -> _Array1D[floating[_16Bit] | Any] | ndarray[_AnyShape, dtype[floating[_16Bit] | Any]]:
        ...
    ...
    def pacf(self, lags=...): # -> _Array1D[float64]:
        ...

    @Appender(remove_parameters(arma_periodogram.__doc__, ["ar", "ma", "worN", "whole"]))
    def periodogram(self, nobs=...): # -> tuple[NDArray[float64], Any]:
        ...

    @Appender(remove_parameters(arma_impulse_response.__doc__, ["ar", "ma"]))
    def impulse_response(self, leads=...): # -> ndarray[_AnyShape, dtype[Any]] | tuple[ndarray[_AnyShape, dtype[Any]], ndarray[_AnyShape, dtype[Any]]]:
        ...

    @Appender(remove_parameters(arma2ma.__doc__, ["ar", "ma"]))
    def arma2ma(self, lags=...): # -> ndarray[_AnyShape, dtype[Any]] | tuple[ndarray[_AnyShape, dtype[Any]], ndarray[_AnyShape, dtype[Any]]]:
        ...

    @Appender(remove_parameters(arma2ar.__doc__, ["ar", "ma"]))
    def arma2ar(self, lags=...): # -> ndarray[_AnyShape, dtype[Any]] | tuple[ndarray[_AnyShape, dtype[Any]], ndarray[_AnyShape, dtype[Any]]]:
        ...
    ...
    def invertroots(self, retnew=...): # -> Self | tuple[Any | ndarray[tuple[int], dtype[Any]] | None, bool]:
        """
    ...
    def generate_sample(self, nsample=..., scale=..., distrvs=..., axis=..., burnin=...): # -> ndarray[_AnyShape, dtype[Any]]:
        ...
