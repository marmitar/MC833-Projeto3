...
def cy_hamilton_filter_log(initial_probabilities, regime_transition, conditional_loglikelihoods, model_order): # -> tuple[ndarray[_AnyShape, dtype[Any]] | Any, NDArray[Any], _Array[tuple[int], float64], ndarray[_AnyShape, dtype[Any]], _Array1D[float64], ndarray[_AnyShape, dtype[float64]]]:
    """
...
class MarkovSwitching(tsbase.TimeSeriesModel):
    ...
    def regime_transition_matrix(self, params, exog_tvtp=...): # -> ndarray[tuple[int, int, int], dtype[Any]]:
        """
    ...
    def loglikeobs(self, params, transformed=...): # -> _Array[tuple[int], float64]:
        """
    ...
    def fit(self, start_params=..., transformed=..., cov_type=..., cov_kwds=..., method=..., maxiter=..., full_output=..., disp=..., callback=..., return_params=..., em_iter=..., search_reps=..., search_iter=..., search_scale=..., **kwargs): # -> ndarray[_AnyShape, dtype[Any]] | MarkovSwitchingResultsWrapper:
        """
    ...
    def transform_params(self, unconstrained): # -> ndarray[_AnyShape, dtype[Any]]:
        """
    ...
    def untransform_params(self, constrained): # -> ndarray[_AnyShape, dtype[Any]]:
        """
...
class HamiltonFilterResults:
    ...
    @property
    def expected_durations(self): # -> ndarray[_AnyShape, dtype[Any]]:
        """
