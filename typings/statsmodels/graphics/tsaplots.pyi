...
def plot_pacf(
    ...
    lags: int | ArrayLike | None=None,
    alpha: float=0.05,
    method: Literal['ywm', 'ywmle', 'yw', 'ymadjusted', 'ols', 'ols-inefficient', 'ld', 'ldadjusted', 'ldb', 'ldbiased']='ywm',
    use_vlines: bool=True,
...
def plot_ccf(x, y, *, ax=..., lags=..., negative_lags=..., alpha=..., use_vlines=..., adjusted=..., fft=..., title=..., auto_ylims=..., vlines_kwargs=..., **kwargs): # -> Figure:
    """
...
def plot_accf_grid(x, *, varnames=..., fig=..., lags=..., negative_lags=..., alpha=..., use_vlines=..., adjusted=..., fft=..., missing=..., zero=..., auto_ylims=..., bartlett_confint=..., vlines_kwargs=..., **kwargs): # -> Figure:
    """
