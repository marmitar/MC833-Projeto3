...
class OriginResults(RegressionResults):
    ...
    def el_test(self, b0_vals, param_nums, method=..., stochastic_exog=..., return_weights=...): # -> tuple[Any, ndarray[_AnyShape, dtype[Any]] | ndarray[tuple[()], dtype[Any]], Any] | tuple[Any, ndarray[_AnyShape, dtype[Any]] | ndarray[tuple[()], dtype[Any]]]:
        """
