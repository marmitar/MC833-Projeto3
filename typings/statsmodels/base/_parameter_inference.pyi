...
@author: josef
"""
def score_test(self, exog_extra=..., params_constrained=..., hypothesis=..., cov_type=..., cov_kwds=..., k_constraints=..., r_matrix=..., scale=..., observed=...): # -> tuple[Any, ndarray[_AnyShape, dtype[Any]] | ndarray[tuple[()], dtype[Any]], Any] | tuple[tuple[Any, ndarray[_AnyShape, dtype[Any]] | ndarray[tuple[()], dtype[Any]], Any], ndarray[_AnyShape, dtype[Any]] | ndarray[tuple[()], dtype[Any]]] | tuple[Any, ndarray[_AnyShape, dtype[Any]] | ndarray[tuple[()], dtype[Any]]]:
...
def gbic(results, gbicp=...): # -> tuple[Any, Any]:
