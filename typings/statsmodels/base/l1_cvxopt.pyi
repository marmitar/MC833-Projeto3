...
"""
def fit_l1_cvxopt_cp(f, score, start_params, args, kwargs, disp=..., maxiter=..., callback=..., retall=..., full_output=..., hess=...): # -> tuple[Any | ndarray[_AnyShape, dtype[Any]], dict[str, Any | float | NDArray[Any]] | Any] | ndarray[_AnyShape, dtype[Any]]:
    """
