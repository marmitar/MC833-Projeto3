...
class Logit(Link):
    ...
    def inverse(self, z): # -> NDArray[float64]:
        """
...
class CDFLink(Logit):
    ...
    def __call__(self, p): # -> ndarray[_AnyShape, dtype[Any]] | _Array[tuple[()], Any]:
        """
        CDF link function
    ...
    def inverse(self, z): # -> ndarray[_AnyShape, dtype[Any]] | ndarray[tuple[()], dtype[Any]]:
        """
    ...
    def deriv(self, p): # -> NDArray[float64]:
        """
    ...
    def deriv2_numdiff(self, p): # -> NDArray[float64]:
        """
        Second derivative of the link function g''(p)
    ...
    def inverse_deriv(self, z): # -> ndarray[_AnyShape, dtype[Any]] | ndarray[tuple[()], dtype[Any]]:
        """
    ...
    def inverse_deriv2(self, z): # -> NDArray[float64]:
        """
        Second derivative of the inverse link function g^(-1)(z).
