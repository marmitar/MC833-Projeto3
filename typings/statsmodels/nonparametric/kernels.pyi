...
def wang_ryzin_convolution(h, Xi, Xj): # -> _Array1D[float64]:
    ...

def aitchison_aitken_convolution(h, Xi, Xj): # -> _Array1D[float64]:
    ...

def gaussian_cdf(h, Xi, x):
    ...

def aitchison_aitken_cdf(h, Xi, x_u): # -> _Array1D[float64]:
    ...

def wang_ryzin_cdf(h, Xi, x_u): # -> _Array1D[float64]:
    ...

def d_gaussian(h, Xi, x):
    ...

def aitchison_aitken_reg(h, Xi, x): # -> _Array1D[float64]:
    """
