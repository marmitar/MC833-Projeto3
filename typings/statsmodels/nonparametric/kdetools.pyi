...
def forrt(X, m=...): # -> Incomplete:
    """
    RFFT with order like Munro (1976) FORTT routine.
    """
    ...

def revrt(X, m=...): # -> ndarray[_AnyShape, dtype[float64]]:
    """
    Inverse of forrt. Equivalent to Munro (1976) REVRT routine.
    """
    ...

def silverman_transform(bw, M, RANGE): # -> Incomplete:
    """
...
def counts(x, v): # -> NDArray[intp] | Incomplete:
    """
